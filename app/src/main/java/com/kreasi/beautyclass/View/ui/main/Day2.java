...
public class Day2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listAgenda.addAll(AgendaData.getSchedule("Thursday, 13 April 2019"));
        adapter= new AgendaVPAdapter(getContext(),listAgenda);

        vpAgenda = view.findViewById(R.id.AgendaV2D2);
        ...
        vpAgenda.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int i, float v, int i1) {
                title= view.findViewById(R.id.titleDescAgendaV2D2);
                desc = view.findViewById(R.id.DescAgendaV2D2);
                speaker= view.findViewById(R.id.speakernameV2D2);
                ...
                View mView=view.findViewById(R.id.backAgenV2D2);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        card = view.findViewById(R.id.spkCardV2D2);
